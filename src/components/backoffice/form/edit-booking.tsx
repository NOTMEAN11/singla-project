...
function EditBooking({ booking }: Props) {
  ...
  const roomPrice =
    room.find((item) => item.id === roomId)?.roomType.price ||
        ...
        <div className="col-span-2">
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value={booking.roomId}>
                            {currentRoom?.name}
                          </SelectItem>
                        </SelectContent>
                      </Select>
          ...
          <div className="space-y-2">
            ...
            <div>
              <h1>
                ราคาเก่า{" "}
                <span className="text-xs text-gray-500">(ราคาในฐานข้อมูล)</span>
              </h1>
              <Input value={booking.totalPrice.toFixed(2)} readOnly disabled />
            </div>
            <div className="space-y-2">
